...
module.exports = async function (req, res) {
    ...
    if (statisticId == null) {
        try {
            ...
            return res.status(200).json({ success: statistics != null, data: statistics, error_code: 0, error_message: "" })
            ...
            return res.status(200).json({ success: false, data: [], error_code: 2, error_message: "Ошибка в БД" })
        }
        ...
        return res.status(200).json({ success: result != null, data: result, error_code: 0, error_message: "" })
    }
